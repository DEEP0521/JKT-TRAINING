...
//  
//  @RestController 
//  public class UploadFileController extends Bill 
//  {
//	  @Autowired
//	  private BillService billservice;
//	  
//	  @PostMapping("/file") public ResponseEntity UploadFile(@ModelAttribute Bill bill ,@RequestParam("file") MultipartFile file)
//	  {
//		  Bill b=new Bill();
...
//			  e.printStackTrace();
//		}
//		  Bill b1=new Bill(bill.getType(),bill.getMonth(),bill.getRemark());
//		  //billservice.postBill(b1);
//		  String fileDownloadUri=ServletUriComponentsBuilder
//				  .fromCurrentContextPath()
//				  .path("/F:\\savedfiles").path(fileName).path("/db").toUriString();
